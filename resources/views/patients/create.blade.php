<x-app-layout :hideHeader="true">
    ...
    <div class="max-w-xl px-4 py-6 mx-auto pb-28">
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-500">Daftarkan hewan peliharaan baru</p>
        </div>

        <form action="{{ route('patients.store') }}" method="POST" x-data="patientForm()" @submit="isSubmitting = true">
            @csrf
