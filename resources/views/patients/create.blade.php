                    ...
                    <form action="{{ route('patients.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <select name="owner_id" id="owner_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-birawa-500 focus:ring focus:ring-birawa-500 focus:ring-opacity-50" required>
                                    ...
                                    @foreach($owners as $owner)
                                        <option value="{{ $owner->id }}" {{ (old('owner_id') == $owner->id || (isset($selectedOwnerId) && $selectedOwnerId == $owner->id)) ? 'selected' : '' }}>
                                            {{ $owner->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="breed" id="breed" value="{{ old('breed') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-birawa-500 focus:ring focus:ring-birawa-500 focus:ring-opacity-50">
                                @error('breed')
                                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="dob" id="dob" value="{{ old('dob') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-birawa-500 focus:ring focus:ring-birawa-500 focus:ring-opacity-50">
                                @error('dob')
                                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="col-span-1 md:col-span-2">
                                ...
                                <div class="flex items-center space-x-6">
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="gender" value="jantan" class="form-radio text-birawa-600 focus:ring-birawa-500" {{ old('gender') == 'jantan' ? 'checked' : '' }} required>
                                        <span class="ml-2 text-gray-700">Male (Jantan)</span>
                                    </label>
                                    <label class="inline-flex items-center">
                                        <input type="radio" name="gender" value="betina" class="form-radio text-birawa-600 focus:ring-birawa-500" {{ old('gender') == 'betina' ? 'checked' : '' }} required>
