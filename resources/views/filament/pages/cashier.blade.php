    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-4">
            ...
            <div class="p-4 bg-white rounded-lg shadow dark:bg-gray-800">
                ...
                <div class="flex justify-between items-center mb-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <span class="text-lg font-medium text-gray-900 dark:text-white">Total</span>
                    <span class="text-2xl font-bold text-blue-600 dark:text-blue-400">Rp {{ number_format($total, 0, ',', '.') }}</span>
                </div>
