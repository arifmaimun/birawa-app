<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="mb-6">
            ...
            <p class="text-sm text-slate-500">Create a new service offering</p>
        </div>
                    ...
                    <div class="grid grid-cols-1 gap-6 mb-8">
                        ...
                        <div>
                            ...
                            <input type="text" id="service_name" name="service_name" 
                                   ...
                                   value="{{ old('service_name') }}" required autofocus placeholder="e.g. Basic Consultation">
                        ...
                        <div>
                            ...
                            <!-- Calculator -->
                            <div x-show="showCalculator" class="mt-2 p-4 bg-slate-50 rounded-xl border border-slate-100" x-transition style="display: none;">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="unit" name="unit" class="w-full rounded-xl border-slate-200 focus:border-birawa-500 focus:ring-birawa-500 shadow-sm transition-colors">
                                    <option value="session">Minutes / Session</option>
