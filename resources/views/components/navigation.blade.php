<nav x-data="{ open: false }" class="z-30">
    ...
    <div class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-slate-200 h-20 z-50 flex justify-around items-center px-2 pb-safe transition-transform duration-300">
        ...
        <div class="relative w-full h-full flex flex-col items-center justify-center">
            ...
            <div x-show="open" @click.away="open = false" 
                 ...
                 <a href="{{ route('friends.index') }}" class="flex items-center px-4 py-3 text-sm text-slate-700 hover:bg-slate-50 border-b border-slate-50 transition-colors">
                    <svg class="w-5 h-5 mr-3 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    Friends
                 </a>
                 <a href="{{ route('chat.index') }}" class="flex items-center px-4 py-3 text-sm text-slate-700 hover:bg-slate-50 border-b border-slate-50 transition-colors">
                    <svg class="w-5 h-5 mr-3 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                 ...
                 <div class="px-4 py-3 bg-slate-50 border-b border-slate-100">
                    <p class="text-xs font-semibold text-slate-500 uppercase tracking-wider">Clinic</p>
                 </div>
    ...
    <div class="hidden md:flex fixed top-16 left-0 h-[calc(100vh-4rem)] w-64 bg-white border-r border-slate-200 flex-col overflow-y-auto z-40 pb-4">
        <div class="py-4 px-4">
            ...
            <p class="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-4 mt-8 px-2">Social</p>
            <div class="space-y-1">
                <a href="{{ route('friends.index') }}" class="flex items-center px-2 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('friends.*') ? 'bg-birawa-50 text-birawa-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }} transition-colors">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('friends.*') ? 'text-birawa-600' : 'text-slate-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
                    Friends
                </a>
                <a href="{{ route('chat.index') }}" class="flex items-center px-2 py-2.5 text-sm font-medium rounded-xl {{ request()->routeIs('chat.*') ? 'bg-birawa-50 text-birawa-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900' }} transition-colors">
                    <svg class="w-5 h-5 mr-3 {{ request()->routeIs('chat.*') ? 'text-birawa-600' : 'text-slate-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                    Chat
                </a>
