            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('admin.users.create') }}" class="bg-birawa-600 hover:bg-birawa-700 text-white font-bold py-2 px-4 rounded">
                            Add New User
                        </a>
                    </div>
                    ...
                    <div class="mb-4">
                        <form action="{{ route('admin.users.index') }}" method="GET" class="flex gap-2">
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Search by name or email..." class="border-gray-300 rounded-md shadow-sm focus:border-birawa-500 focus:ring focus:ring-birawa-200 focus:ring-opacity-50 w-full sm:w-64">
